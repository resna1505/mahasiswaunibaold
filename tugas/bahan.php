    ...
    if ( $_SESSION['token'] == $_POST['sessid'] )
    {
        ...
        else
        {
            ...
            else
            {
                ...
                $idbaru = getnewidsyarat( "IDBAHAN", "tugaskuliah", "\r\n\t\t\tWHERE IDMAKUL='{$idmakulupdate}' AND\r\n\t\t\tTAHUN='{$tahunupdate}' AND\r\n\t\t\tSEMESTER='{$semesterupdate}' AND\r\n\t\t\tKELAS='{$kelasupdate}'\r\n\t\t\t" );
                if ( $filebahan != "" )
                {
...
if ( $aksi == "formtambah" )
{
                ...
                <div class=\"col-md-12\">
                    ...
                    ";
                        ...
                        echo "			<div class='portlet-title'>";
												printmesg("Upload Tugas Kuliah");
								echo "	</div>";
	echo "  	<div class=\"m-portlet\">				
					<!--begin::Form-->";
	#echo "\r\n\t\t<table class=form>\r\n \t\t <tr valign=top class=judulform>\r\n\t\t\t<td class=judulform><b>Nama Tugas</td>\r\n\t\t\t<td>".createinputtext( "nama", "{$nama}", "size=50 class=form-control m-input" )."</td>\r\n\t\t</tr> \r\n    <tr valign=top  class=judulform>\r\n\t\t\t<td><b>Keterangan</td>\r\n\t\t\t<td>";
    ...
    if ( 0 < sqlnumrows( $h ) )
    {
        ...
        while ( $d = sqlfetcharray( $h ) )
        {
            ...
            {
                echo "\r\n     \t\t\t<td align=center>".createinputcek( "data[{$d['IDBAHAN']}][hapus]", "1", "", "", " class=form-control m-input size=4" )."</td>";
            }
            else
            {
                echo "\r\n     \t\t\t<td align=center>-</td>";
    ...
    {
        $errmesg = "Tugas Kuliah belum ada";
        printmesg( $errmesg );
    }
}
...
if ( $aksi == "tambahawal" )
{
    ...
    echo "\r\n\r\n \t\t <tr class=judulform>\r\n\t\t\t<td>Kelas</td>\r\n\t\t\t<td>\r\n  ".createinputselect( "kelas", $arraylabelkelas, $kelas, "", "" )."      \r\n      \r\n  </td>\r\n\t\t</tr> \r\n\t\t\t<tr>\r\n\t\t\t\t<td colspan=2>\r\n\t\t\t\t\t<input type=submit value='Lanjut' class=form-control m-input>\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t</table>\r\n\t\t</form>\r\n \t";
*/
	echo "<div class=\"page-content\">
        <div class=\"container-fluid\">
			<div class=\"row\">
...
if ( $aksi == "" )
{
    /*printjudulmenu( "Lihat Tugas Kuliah   " );
    printmesg( $errmesg );
    ...
    echo "\r\n\t\t\t\t\t\t</select>\r\n\t\t\t</td>\r\n\t\t</tr> ";
    $arraylabelkelas[''] = "Semua";
    echo "      \r\n\r\n \t\t <tr class=judulform>\r\n\t\t\t<td>Kelas</td>\r\n\t\t\t<td>\r\n  ".createinputselect( "kelas", $arraylabelkelas, $kelas, "", "" )."      \r\n      \r\n </td>\r\n\t\t</tr> \r\n\t\t\t<tr>\r\n\t\t\t\t<td colspan=2>\r\n\t\t\t\t\t<input type=submit value='Tampilkan' class=form-control m-input>\r\n\t\t\t\t</td>\r\n\t\t\t</tr>\r\n\t\t</table>\r\n\t\t</form>\r\n\t\t<script>\r\n\t\t\tform.idmakul.focus();\r\n\t\t</script>\r\n\t";
	*/
	echo "<div class=\"page-content\">
        <div class=\"container-fluid\">
			<div class=\"row\">
