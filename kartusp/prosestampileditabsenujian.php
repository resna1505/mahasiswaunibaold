...
if ( 0 < sqlnumrows( $h ) )
{
    ...
    if ( $jenis == "UTS" )
    {
        $bodycetak .= "<td align=center><b>Nilai </td>\r\n              <td align=center><b>Tanda Tangan </td>";
    }
    else
    {
        if ( $jenis == "UAS" )
        ...
        else
        {
            ...
            if ( $UNIVERSITAS == "STIKES SAMARINDA" )
            {
                ...
                while ( $ii <= $datakuliah )
                {
                    $bodycetak .= "<td align=center width=30 align=center><b>{$ii}</td>";
                    ++$ii;
                }
            }
    ...
    if ( $jenis == "Kuliah" )
    {
        ...
        while ( $ii <= $datakuliah )
        {
            $bodycetak .= "<td align=center width=30 align=center>Hr: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>Tgl:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>";
            ++$ii;
        }
        $bodycetak .= "\r\n            </tr>\r\n          ";
    }
