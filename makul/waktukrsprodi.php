...
if ( $prodis == "" )
{
    ...
    #printjudulmenu( "Edit Waktu KRS Online -  KHUSUS" );
...
<div class=\"row\">
                        ...
                        <div class=\"portlet-body form\"><div class='tab-pane' id='tab_1'>
								<div class='portlet box blue'>
									<div class='portlet-title'>
										<div class='caption'>";
											printmesg("Edit Waktu KRS Online -  KHUSUS");
								echo	"</div>
									</div>";
    ...
    if ( $aksi == "hapus" )
    {
        ...
        else
        {
            ...
            $q = "DELETE FROm waktukrsprodi WHERE TAHUN='{$tahunhapus}' AND SEMESTER='{$semesterhapus}'\r\n  AND ANGKATAN='{$angkatanhapus}' AND PRODI='{$idprodihapus}'";
    ...
    if ( $aksi == "" )
    {
        ...
        echo "<div class='portlet-body form'>
				<table class=\"table table-striped table-bordered table-hover\">";
        echo "   <tr>\r\n          <td style=\"width:20%\">Tahun/Semester</td>\r\n          <td><input type=checkbox name=iftahun value=1>\r\n\r\n\r\n\t\t\t\t\t\t<select name=tahun  class=masukan> \r\n\t\t\t\t\t ";
		$arrayangkatan = getarrayangkatan( "WP" );
		#echo $arrayangkatan;
        ...
        echo "\r\n            </select>\r\n          </td>\r\n        </tr>\r\n    <tr>\r\n      <td>\r\n        Prodi \r\n      </td>\r\n      <td><input type=checkbox name=ifprodi value=1>\r\n        <select name=idprodi>\r\n         ";
		...
		#echo $arrayangkatan;exit();
        echo "\r\n        </select>\r\n        \r\n      </td>\r\n    </tr>\r\n    <tr>\r\n      <td>\r\n        Angkatan \r\n        </td><td><input type=checkbox name=ifangkatan value=1>\r\n       <select name=angkatan>\r\n         ";
        #foreach ( $arrayangkatan as $k => $v )
        #{
		$i = 2000;
        ...
        if ( $aksi2 == "Tampilkan" )
        {
            ...
            {
                printmesg( "Data Waktu KRS Online Khusus Tidak Ada. <br>{$jfield}" );
            }
        }
    }
	echo "							</div>
