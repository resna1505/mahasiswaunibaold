...
$arraysort[5] = "jadwalkuliahkurikulum.KELAS";
$arraysort[6] = "jadwalkuliahkurikulum.JENISKELAS";
$arraysort[7] = "jadwalkuliahkurikulum.JAM";
$arraysort[8] = "jadwalkuliahkurikulum.HARI";
$arraysort[9] = "jadwalkuliahkurikulum.RUANGAN";
$arraysort[10] = "jadwalkuliahkurikulum.DOSEN";
$arraysort[11] = "jadwalkuliahkurikulum.KUOTA";
$arraysort[12] = "jadwalkuliahkurikulum.TERISI";
...
$q = "SELECT tbkmk.NAKMKTBKMK NAMA,makul.ID,\r\n      mspst.IDX AS IDPRODI,\r\n     tbkmk.*,SKSMKTBKMK AS SKS ,     \r\n      SEMESTBKMK  +0 AS SEMESTER ,\r\n      jadwalkuliahkurikulum.*\r\n      \r\n      FROM makul,mspst,tbkmk ,jadwalkuliahkurikulum\r\n      \r\n\tWHERE \r\n  makul.ID=tbkmk.KDKMKTBKMK AND\r\n \r\n  mspst.KDPSTMSPST=tbkmk.KDPSTTBKMK AND\r\n  mspst.KDJENMSPST=tbkmk.KDJENTBKMK AND\r\n  mspst.KDPTIMSPST=tbkmk.KDPTITBKMK AND\r\n  jadwalkuliahkurikulum.IDPRODI=mspst.IDX AND\r\n  jadwalkuliahkurikulum.IDMAKUL=tbkmk.KDKMKTBKMK AND\r\n  CONCAT(jadwalkuliahkurikulum.TAHUN-1,jadwalkuliahkurikulum.SEMESTER)=tbkmk.THSMSTBKMK \r\n  \r\n {$qprodideptbkmk}\r\n\t{$qfield}\r\n\tORDER BY ".$arraysort[$sort]." {$qlimit}";
$h = mysqli_query($koneksi,$q);
if ( 0 < sqlnumrows( $h ) )
{
    if ( $aksi != "cetak" )
