...
$arraysort[0] = "pengambilanmk.TAHUN";
$arraysort[1] = "pengambilanmk.TAHUN";
$arraysort[2] = "pengambilanmk.IDMAHASISWA";
$arraysort[3] = "";
$arraysort[4] = "pengambilanmk.IDMAKUL";
$arraysort[5] = "";
$arraysort[6] = "pengambilanmk.SKSMAKUL";
$arraysort[7] = "pengambilanmk.KELAS";
$arraysort[8] = "pengambilanmk.TAHUN,pengambilanmk.IDMAHASISWA,pengambilanmk.IDMAKUL";
...
if ( $semester != "" )
{
    $qfield .= " AND pengambilanmk.SEMESTER = '{$semester}'";
    $qjudul .= " Semester ".$arraysemester[$semester]." <br>";
    $qinput .= " <input type=hidden name=semester value='{$semester}'>";
    $href .= "semester={$semester}&";
}
...
$q = "SELECT COUNT(*) AS JML FROM pengambilanmk,makul,mahasiswa WHERE 1=1 {$qprodidep4} AND mahasiswa.ID=pengambilanmk.IDMAHASISWA AND makul.ID=pengambilanmk.IDMAKUL {$qfield}";
...
$q = "SELECT pengambilanmk.*,makul.NAMA AS NAMAMAKUL,mahasiswa.NAMA AS NAMAMAHASISWA,mahasiswa.ANGKATAN,makul.SKS FROM pengambilanmk,makul,mahasiswa WHERE 1=1 {$qprodidep4} AND mahasiswa.ID=pengambilanmk.IDMAHASISWA AND makul.ID=pengambilanmk.IDMAKUL {$qfield} ORDER BY ".$arraysort[$sort]." {$qlimit}";
