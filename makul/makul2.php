...
if ( $aksi2 == "formupdate" )
{
    $q = "SELECT * FROM tbkmk WHERE KDKMKTBKMK='{$idupdate}' AND THSMSTBKMK='{$tahunsemester}'\r\n    AND KDJENTBKMK='{$jenjangupdate}'\r\n    AND KDPSTTBKMK='{$prodiupdate}'";
...
if ( $d2[NAKMKTBKMK] == "" )
{
    $d2[NAKMKTBKMK] = "{$namamakul}";
}
if ( $aksi2 == "formupdate" )
{
    echo "	<div class=\"form-group m-form__group row\">
				<label class=\"col-lg-2 col-form-label\">Kode Mata Kuliah Baru</label>\r\n    
				<div class=\"col-lg-6\"><input type=text size=20 name=idmakulbaru value='{$idupdate}' class=form-control m-input> Pastikan Kode Mata Kuliah Baru sudah ada di data Master Mata Kuliah.</div>
			</div>";
}
echo " 		<div class=\"form-group m-form__group row\" style=\"background-color:#f7f8fa;\">
			...
			<div class=\"form-group m-form__group row\">
				...
				<div class=\"col-lg-6\">";
					if ( $aksi2 == "formtambah" || $pilihan == "mtambah" )
					{
						$waktu = getdate( );
						if ( $tahun2 == "" )
						{
				...
				<div class=\"col-lg-6\">";
					if ( $aksi2 == "formtambah" || $pilihan == "mtambah" )
					{
						echo createinputtext( "prodi1", $d2[KDPSTTBKMK], "{$readonlymakul} class=form-control m-input  size=5  id='inputStringProdiPT' onkeyup=\"lookupProdiPT(this.value);\" placeholder=\"Ketik Prodi Perguruan Tinggi...\" " )."
							<!--<a href=\"javascript:daftarprodipt('form,wewenang,prodi1',document.form.prodi1.value)\" >
...
echo "			</div>
			...
			<div class=\"form-group m-form__group row\" style=\"background-color:#f7f8fa;\">
				...
				<div class=\"col-lg-6\">
					...
					<a href=\"javascript:daftarprodipt('form,wewenang,prodi',document.form.prodi.value)\" >daftar Referensi Program Studi di P.T.</a>-->
