...
{
    $aksi = " ";
    include( "proseslap2.php" );
}
if ( $aksi == "" )
{
    #printjudulmenu( "Daftar Mahasiswa yang Belum Mengambil KRS" );
    #printmesg( $errmesg );
...
<div class=\"row\">
                    ...
                    <div class=\"portlet light\">
                        <div class=\"portlet-title\">
                            <div class=\"caption font-green-haze\">
                                ...
                                <span class=\"caption-subject bold uppercase\"> Daftar Mahasiswa yang Belum Mengambil KRS </span>
                            </div>
                            <div class=\"actions\">
	 ...
	 echo "<div class=\"page-content\">
		...
		echo "			<div class='portlet-title'>";
								printmesg("Daftar Mahasiswa yang belum mengambil KRS");
				echo "	</div>";
    ...
    echo "  <div class=\"form-group m-form__group row\">
			...
			<div class=\"form-group m-form__group row\"  style=\"background-color:#f7f8fa;\">
				...
				<div class=\"col-lg-6\"><select class=form-control m-input name=status>\r\n\t\t\t\t\t\t<option value=''>Semua</option>";
