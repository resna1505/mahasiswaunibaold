...
if ( $prodis == "" )
{
    ...
    #printjudulmenu( "Edit Waktu KRS Online -  UMUM" );
    if ( $aksi == "hapus" )
    {
        ...
        else
        {
            ...
            $q = "DELETE FROm waktukrs WHERE TAHUN='{$tahunhapus}' AND SEMESTER='{$semesterhapus}'";
                    ...
                    <div class=\"portlet light\">
                        <div class=\"portlet-title\">
                            <div class=\"caption font-green-haze\">
                                ...
                                <span class=\"caption-subject bold uppercase\"> Edit Waktu KRS Online -  UMUM </span>
                            </div>
                            <div class=\"actions\">
...
<div class=\"row\">
                    ...
                    <div class=\"portlet light\">
                        <div class=\"portlet-body form\"><div class='tab-pane' id='tab_1'>
								<div class='portlet box blue'>
									<div class='portlet-title'>
										<div class='caption'>";
											printmesg("Edit Waktu KRS Online -  UMUM");
								echo	"</div>
									</div>
									<div class='portlet-body form'>";
        ...
        $q = "SELECT * FROM waktukrs ORDER BY TAHUN,SEMESTER";
        ...
        if ( 0 < sqlnumrows( $h ) )
        {
            ...
            echo "<div class=\"portlet light\">
                        <div class=\"portlet-title\">
                            <div class=\"caption font-green-haze\">";
                                printmesg("Data Waktu KRS Online");
            echo "           </div>
                        </div>";
