...
else
{
    ...
    else if ( $pilihan == "hapuskurikulum" )
    {
    ...
    else if ( $pilihan == "koreksikurikulum" )
    {
        include( "koreksikurikulum.php" );
    }
    else if ( $pilihan == "koreksidosenpengajar" )
    {
        include( "koreksidosenpengajar.php" );
    }
    else if ( $pilihan == "koreksikrs" )
    {
        include( "koreksikrs.php" );
    }
    else if ( $pilihan == "mhsmakul" )
    {
        include( "mhsmakul.php" );
    }
    else
    {
        if ( $pilihan == "kelompokkurikulum" )
        {
            include( "kelompokkurikulum.php" );
        }
        else
        {
            if ( $pilihan == "tampilankrs" )
            {
                include( "tampilankrs.php" );
            }
        }
    }
}
