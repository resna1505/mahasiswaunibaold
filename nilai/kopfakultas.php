...
$d = getsettingkopfakultas( $idfakultas );
if ( $aksi == "simpan" )
{
        ...
        else
        {
            ...
            if ( $latarfoto != "" )
            {
                ...
                if ( strtolower( $ext ) == "jpeg" || strtolower( $ext ) == "jpg" || strtolower( $ext ) == "gif" || strtolower( $ext ) == "png" || strtolower( $ext ) == "bmp" )
                {
                    ...
                    move_uploaded_file( $latarfoto, "kartu/{$idfakultas}/latarfoto.{$ext}" );
                }
            }
            if ( $filelogokiri != "" )
            {
                ...
                if ( strtolower( $ext ) == "jpeg" || strtolower( $ext ) == "jpg" || strtolower( $ext ) == "gif" || strtolower( $ext ) == "png" || strtolower( $ext ) == "bmp" )
                {
                    ...
                    move_uploaded_file( $filelogokiri, "kartu/{$idfakultas}/logokiri.{$ext}" );
                }
            }
            if ( $filelogokanan != "" )
            {
                ...
                if ( strtolower( $ext ) == "jpeg" || strtolower( $ext ) == "jpg" || strtolower( $ext ) == "gif" || strtolower( $ext ) == "png" || strtolower( $ext ) == "bmp" )
                {
                    ...
                    move_uploaded_file( $filelogokanan, "kartu/{$idfakultas}/logokanan.{$ext}" );
                }
            }
            $qdata = "";
...
if ( $aksi == "Proses" )
{
	...
	echo "						<div class='portlet-title'>";
											printmesg("Setting Kop Surat Per {$JUDULFAKULTAS}");
											printmesg( $errmesg );
	echo "						</div>";		
    echo "						<form class=\"m-form m-form--fit m-form--label-align-right m-form--group-seperator\" name=form action=index.php method=post ENCTYPE='MULTIPART/FORM-DATA'>
									".createinputhidden( "idfakultas", $idfakultas, "" ).createinputhidden( "pilihan", $pilihan, "" ).createinputhidden( "sessid", $_SESSION['token'], "" ).createinputhidden( "aksi", "simpan", "" )."
									<div class=\"m-portlet\">
										<div class=\"m-section__content\">
											<div class=\"table-responsive\">
												<table class=\"table table-bordered table-hover\">
													<thead>	
														<tr class=judulform valign=top>\r\n\t\t\t<td colspan=2><B>KOP di bawah ini akan muncul pada laporan2 yg dibuat, apabila pilihan Kop Surat {$JUDULFAKULTAS} dipilih saat pembuatan laporan2 tersebut.</td></tr>
													</thead>	
													<tbody>
										...
										<div class=\"m-portlet__body\">
											<div class=\"form-group m-form__group row\" style=\"background-color:#f7f8fa;\">
												...
												<label class=\"col-form-label\" style=\"padding-left:0;width:auto;\">
													<select class=form-control m-input name=idfakultas>";
														unset( $arrayfakultas[''] );
