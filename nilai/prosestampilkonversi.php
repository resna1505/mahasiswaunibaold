...
periksaroot( );
$href = "index.php?pilihan={$pilihan}&tab={$tab}&aksi=tampilkan&";
if ( $idmakul != "" )
{
...
if ( $sort == "" )
{
    $sort = " konversi.TAHUN,IDMAKUL,KELAS";
}
$qinput .= " <input type=hidden name=sort value='{$sort}'>";
$q = "SELECT dosenpengajar.*,makul.NAMA AS NAMAMAKUL,dosen.NAMA AS NAMADOSEN,konversi.NAMA,BOBOT \r\n\tFROM dosenpengajar,makul,dosen,konversi \r\n\tWHERE 1=1\r\n\tAND dosen.ID=dosenpengajar.IDDOSEN \r\n\tAND makul.ID=dosenpengajar.IDMAKUL\r\n\tAND konversi.IDMAKUL=makul.ID\r\n\tAND konversi.TAHUN=dosenpengajar.TAHUN\r\n\t{$qfield}\r\n\tORDER BY {$sort}";
