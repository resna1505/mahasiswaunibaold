...
if ( $tab == "" )
{
    ...
    echo "<li><a href='index.php?pilihan={$pilihan}&tab=khusus'>KONVERSI NILAI KHUSUS PER PENGAJAR MATA KULIAH</a>\r\n    <br><br>\r\n    Ini adalah setting khusus per pengajar mata kuliah.  \r\n    <br><br>\r\n    \r\n    </li></ul>
							</div>
						</div>
					</div>
				</div>
