...
{
    $bodytranskrip .= "\r\n\r\n\r\n\r\n\t\t\t\t\t<div style='width:900px; border-top:1px solid black; height:2px;'></div>\r\n\t\t\t\t\t<table width=900  {$borderx}   border=0>\r\n\t\t\t\t\t <thead style='display:table-header-group;'>\r\n\t\t\t\t\t\t<tr class=juduldata{$cetak} align=center>\r\n\t \r\n\t\t\t\t\t\t\t<td align=center rowspan=2><b>NO</td>";
    if ( !$PROFESI )
    {
        $bodytranskrip .= " \r\n    \t \t\t\t\t\t\t<td align=center rowspan=2><b>KEL. MK.</td>\r\n      \t\t\t\t\t\t\t<td align=center rowspan=2><b>KODE MK.</td>\r\n    \t\t\t\t\t\t\t<td align=center rowspan=2><b>MATA KULIAH</td>\r\n    \t\t\t\t\t\t\t<td align=center colspan=4><b>PRESTASI</td>\r\n     \t\t\t\t\t\t\t<td align=center rowspan=2><b>KET</td>";
    }
    else
    {
        $bodytranskrip .= " \r\n  \t\t\t\t\t\t\t<td align=center  ><b>MATA KULIAH</td>\r\n  \t\t\t\t\t\t\t<td align=center><b>HM</td>\r\n    \t\t\t\t\t\t\t<td align=center><b>AM</td>\r\n    \t\t\t\t\t\t\t<td align=center><b>K</td>\r\n     \t\t\t\t\t\t\t<td align=center><b>M</td>\r\n                   <td align=center 2><b>KET</td>  ";
    }
    $bodytranskrip .= "\r\n\r\n\t\t\t\t\t\t</tr>";
    if ( !$PROFESI )
    {
    ...
    if ( is_array( $arraydatatranskrip ) )
    {
        foreach ( $arraydatatranskrip as $k => $d2 )
        {
            if ( $i == 41 )
            {
                $bodytranskrip .= "\r\n\t\t\t\t\t\t{$tmpkop}\r\n    \t\t\t\t\t</table>\r\n    \t\t\t\t\t</div>\r\n    \t\t\t\t\t<div style='page-break-after:always border:1px solid black; width:900px; margin:auto;'> \r\n\t\t\t<table border=0 width=900 style='margin:auto;' >\r\n\t\t\t\t\r\n          <tr align=left>\r\n\t\t\t\t\t\t<td width=200>Nama Mahasiswa</td>\r\n\t\t\t\t\t\t<td>: {$d['NAMA']}</td>\r\n\t\t\t\t\t</tr>\r\n \r\n\t\t\t\t\t<tr align=left>\r\n\t\t\t\t\t\t<td class=judulform>Nomor Pokok Mahasiswa</td>\r\n\t\t\t\t\t\t<td>: {$d['ID']}</td>\r\n\t\t\t\t\t</tr> \r\n        </table>\r\n\r\n\t\t\t\t\t\r\n\t\t\t\t\t<table width=900 {$borderx}   border=0  style='margin:auto;'>\r\n\t\t\t\t\t <thead style='display:table-header-group;'>\r\n\t\t\t\t\t\t<tr class=juduldata{$cetak} align=center>\r\n\t \r\n\t\t\t\t\t\t\t";
                if ( !$PROFESI )
                {
                    $bodytranskrip .= " \r\n    \t \t\t\t\t\t\t";
                }
            ...
            {
                $styleborderkosong = "style='border-bottom:none;font-size:10pt;' ";
            }
            $bodytranskrip .= "\r\n\t\t\t\t\t\t\t<tr {$kelas}{$cetak} align=left valign=top  {$styleborderkosong} >\r\n\t\t\t\t\t\t\t\t<td align=center width=20 {$styleborderkosong}>{$i}</td>";
            if ( !$PROFESI )
            {
                $bodytranskrip .= " \r\n    \t\t\t\t\t\t\t<td  align=center width=80 {$styleborderkosong} >".$namakelompokmk."</td>\r\n                  \t\t\t\t<td  align=center width=80 {$styleborderkosong} >{$d2['IDMAKUL']}</td>";
            }
            $bodytranskrip .= "\r\n\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t<td width=400 {$styleborderkosong} > {$d2['NAMA']} </td>\r\n  \t\t\t\t\t\t\t\t<td align=center width=80 {$styleborderkosong} > {$nilai}</td>\r\n  \t\t\t\t\t\t\t\t<td align=center width=80 {$styleborderkosong} >".number_format_sikad( $bobot, 0 )." </td>\r\n\t\t\t\t\t\t\t\t<td align=center width=80 {$styleborderkosong} >{$d2['SKS']} </td>\r\n  \t\t\t\t\t\t\t\t<td align=center width=80 {$styleborderkosong} >".number_format_sikad( $d2[SKS] * $bobot, 0 )."  </td>\r\n \t\t\t\t\t\t\t\t<td align=center width=80 {$styleborderkosong} > </td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t";
            ++$i;
        }
    }
    if ( $d[JENIS] == 0 )
    ...
    if ( !$PROFESI )
    {
        $bodytranskrip .= "\r\n\t\t\t\t\t\t\t<tr {$kelas}{$cetak}  align=left>\r\n\t\t\t\t\t\t      <td align=center style='border-right:1px solid white;'> </td>\r\n  \t\t\t\t\t\t\t\t<td colspan=4><b>JUMLAH <font style='margin-left:105px;'>:</font></td>\r\n  \t\t\t\t\t\t\t\t<td align=center><b>".number_format_sikad( $totalbobot, 0 )."</td>\r\n  \t\t\t\t\t\t\t\t<td align=center><b>{$bobotsemua} </td>\r\n  \t\t\t\t\t\t\t\t<td align=center><b>".number_format_sikad( $totalbm, 0 )."</td>\r\n\t\t\t\t\t\t      <td align=center > </td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr {$kelas}{$cetak}  align=left>\r\n\t\t\t\t\t\t      <td align=center style='border-right:1px solid white;'> </td>\r\n  \t\t\t\t\t\t\t\t<td colspan=2><b>Nilai Rata-rata</td>\r\n  \t\t\t\t\t\t\t\t<td style='border-left:1px solid white;'>: </td> \r\n\t\t\t\t\t\t      \t<td align=left valign=top colspan=5 rowspan=5 style='border-bottom:1px solid white; border-right:1px solid white;'> \r\n                  Keterangan : <br>\r\n                  \r\n                  <table>\r\n                    <tr>\r\n                      <td>HM</td><td>:</td><td>Huruf Mutu A,B,C,D</td>\r\n                    </tr>\r\n                    <tr>\r\n                      <td>AM</td><td>:</td><td>Angka Mutu 4,3,2,1</td>\r\n                    </tr>\r\n                    <tr>\r\n                      <td>M</td><td>:</td><td>Mutu perkalian dari AM dan K</td>\r\n                    </tr>\r\n                    <tr>\r\n                      <td>K</td><td>:</td><td>Kredit</td>\r\n                    </tr>\r\n                  </table>\r\n                  \r\n                  </td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr {$kelas}{$cetak}  align=left>\r\n\t\t\t\t\t\t      <td align=center style='border-right:1px solid white;'> </td>\r\n  \t\t\t\t\t\t\t\t<td colspan=2  ><b>Tanggal Yudisium</td>\r\n  \t\t\t\t\t\t\t\t<td style='border-left:1px solid white;'>: {$tglyudisium2} </td> \r\n\t\t\t\t\t\t \r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr {$kelas}{$cetak}  align=left>\r\n\t\t\t\t\t\t      <td align=center style='border-right:1px solid white;'> </td>\r\n  \t\t\t\t\t\t\t\t<td colspan=2  ><b>Indeks Prestasi Kumulatif</td>\r\n  \t\t\t\t\t\t\t\t<td style='border-left:1px solid white;'>: {$ipkkuteks}   </td> \r\n\t\t\t\t\t\t \r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr {$kelas}{$cetak}  align=left>\r\n\t\t\t\t\t\t      <td align=center style='border-right:1px solid white;'> </td>\r\n  \t\t\t\t\t\t\t\t<td colspan=3  valign=top ><b>Judul Skripsi</b> <font style='margin-left:80px;'>:</font><br> ".str_replace( "\n", "<br>", $d[TA] )."  </td> \r\n\t\t\t\t\t\t \r\n\t\t\t\t\t\t\t</tr>\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t<tr {$kelas}{$cetak}  align=left>\r\n\t\t\t\t\t\t      <td align=center style='border-right:1px solid white;'> </td>\r\n  \t\t\t\t\t\t\t\t<td colspan=2  ><b>Predikat Kelulusan</td>\r\n  \t\t\t\t\t\t\t\t<td style='border-left:1px solid white;'>: {$predikat} </td> \r\n\t\t\t\t\t\t \r\n\t\t\t\t\t\t\t</tr>\t\t\t              \r\n              \r\n              </table>";
    }
    else
    {
        $bodytranskrip .= "\r\n\t\t\t\t\t\t\t<tr {$kelas}{$cetak}  align=left>\r\n\t\t\t\t\t\t      <td align=left valign=top colspan=2 rowspan=2 style='border-left:1px solid white;border-bottom:1px solid white;'> \r\n\t\t\t\t\t<div style='position:relative; top:38px;'>\t\t\t\t\t\t\t\t  \r\n                  Keterangan : <br>\r\n                  <table>\r\n                    <tr>\r\n                      <td>HM</td><td>:</td><td>Huruf Mutu </td>\r\n                    </tr>\r\n                    <tr>\r\n                      <td>AM</td><td>:</td><td>Angka Mutu </td>\r\n                    </tr>\r\n                    <tr>\r\n                      <td>M</td><td>:</td><td>Mutu </td>\r\n                    </tr>\r\n                    <tr>\r\n                      <td>K</td><td>:</td><td>Kredit</td>\r\n                    </tr>\r\n                  </table>\r\n                  </div>\r\n                  </td>  \t\t\t\t\t\t\t\t\r\n                  <td colspan=2 height=20><b>JUMLAH</td> \r\n  \t\t\t\t\t\t\t\t<td align=center><b>{$bobotsemua} </td>\r\n  \t\t\t\t\t\t\t\t<td align=center><b>".number_format_sikad( $totalbm, 0 )."</td>\r\n\t\t\t\t\t\t      <td align=center > </td>\r\n\t\t\t\t\t\t\t</tr>\r\n \t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr {$kelas}{$cetak}  align=left> \r\n  \t\t\t\t\t\t\t\t<td colspan=5 ><b>Indeks Prestasi<br/>Ujian Kumulatif &nbsp; &nbsp; &nbsp; &nbsp;: {$ipkkuteks}  </td>\r\n  \t\t\t\t\t\t\t \r\n\t\t\t\t\t\t \r\n\t\t\t\t\t\t\t</tr>\r\n \t              \r\n              \r\n              </table>";
    }
    $bodytranskrip .= "\r\n\t\t\t\t \r\n\t\t\t\t\t<table>\r\n\t\t\t\t\t\t<tr  align=left>\r\n\t\t\t\t\t\t\t<td>\r\n \r\n \r\n ";
    @include( "footertranskripuntag.php" );
    $bodytranskrip .= "\r\n\t\t\t\t\t\t";
