...
if ( sqlnumrows( $hprod ) )
{
    ...
    $footerkhs .= " ".$arraylokasi[$idlokasikantor].", {$tgllap['tgl']} ".$arraybulan[$tgllap[bln] - 1]." {$tgllap['thn']} <br>\r\n\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t\t\t";
    ...
    {
       # $footerkhs .= "\r\n            \t\t\t\t\t\t\t\t<br>\r\n                          <img src='../fakultas/lihat.php?idupdate={$idfakultas}' height=80> <br> \r\n            \t\t\t\t\t\t\t\t ";
    }
   # $footerkhs .= "\r\n      \t\t\t\t\t\t\t \r\n      \t\t\t\t\t\t\t\t\t<u>{$namapimpinan}</u> \t\t<br>\t\t\t\t\t\t\t\r\n      \t\t\t\t\t\t\t\t\tNIDN. {$nippimpinan}\t\t\t\t\t\t\t\t\t\r\n      \t\t\t\t\t\t\t\t\t";
    #$footerkhs .= "\r\n      \t\t\t\t\t\t\t\t\t\r\n      \t\t\t\t\t\t\t\t\t\r\n      \t\t\t\t\t\t\t\t\t{$jabatankhs}<br> ";
    if ( $gambarttdkhs != "" )
