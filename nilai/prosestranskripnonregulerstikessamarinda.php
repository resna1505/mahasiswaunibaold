...
if ( $statuspindahan == "P" )
{
    ...
    do
    {
        ...
        {
            $arraydatatranskrip2pindahan["{$dn2['IDMAKUL']}"] = $dn2;
        }
    } while ( 1 );
}
...
@usort( @$arraydatatranskrip2pindahan, "SortByName" );
unset( $arraydatatranskrip );
$arraydatatranskrip = $arraydatatranskrip2pindahan;
$i = $ii = 1;
$semlama = "";
unset( $totals );
if ( is_array( $arraydatatranskrip ) )
{
    $bodytranskrip .= "\r\n\t\t\t\t\t<br>\r\n\t\t\t\t\t<table cellpading=0 cellspacing=0 width=600   >\r\n            <tr>\r\n              <td><b>DAFTAR NILAI PERALIHAN D III KEPERAWATAN DAN MATRIKULASI\r\n              </td></tr>\r\n          </table>\r\n \t\t\t\t\t\t\t\t\t\t<table cellpading=0 cellspacing=0 width=600 class=lineborderblack  >\r\n\t\t\t\t\t <thead style='display:table-header-group;'>\r\n\t\t\t\t\t\t<tr class=juduldata{$cetak} align=center>\r\n\t \r\n\t\t\t\t\t\t\t<td nowrap><b>No.</td>\r\n\t\t\t\t\t\t\t<td nowrap><b>Kode<br>\r\n              <i>(Code)</i>\r\n              </td>\r\n\t\t\t\t\t\t\t<td nowrap><b>Mata Kuliah <br>\r\n              <i>(Subject)</i></td>\r\n\t\t\t\t\t\t\t<td nowrap><b>SKS<br>\r\n              <i>(Credit)</i></td>\r\n\t\t\t\t\t\t\t<td nowrap><b>Mutu<br>\r\n              <i>(Number)</i></td>\r\n\t\t\t\t\t\t\t<td nowrap><b>Lambang<br>\r\n              <i>(Symbol)</i></td>\r\n\t\t\t\t\t\t\t<td nowrap><b>Skor<br>\r\n              <i>(Score)</i></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t</thead>\r\n\t\t\t\t";
    $xxx = 0;
...
if ( is_array( $arraydatatranskrip ) )
{
    $bodytranskrip .= "\r\n\t\t\t\t\t<br>\r\n\t\t\t\t\t<table cellpading=0 cellspacing=0 width=600   >\r\n            <tr>\r\n              <td><b>DAFTAR NILAI YANG DITEMPUH\r\n              </td></tr>\r\n          </table>\r\n \t\t\t\t\t\r\n\t\t\t\t\t<table cellpading=0 cellspacing=0 width=600 class=lineborderblack  >\r\n\t\t\t\t\t <thead style='display:table-header-group;'>\r\n\t\t\t\t\t\t<tr class=juduldata{$cetak} align=center>\r\n\t \r\n\t\t\t\t\t\t\t<td nowrap><b>No.</td>\r\n\t\t\t\t\t\t\t<td nowrap><b>Kode<br>\r\n              <i>(Code)</i>\r\n              </td>\r\n\t\t\t\t\t\t\t<td nowrap><b>Mata Kuliah <br>\r\n              <i>(Subject)</i></td>\r\n\t\t\t\t\t\t\t<td nowrap><b>SKS<br>\r\n              <i>(Credit)</i></td>\r\n\t\t\t\t\t\t\t<td nowrap><b>Mutu<br>\r\n              <i>(Number)</i></td>\r\n\t\t\t\t\t\t\t<td nowrap><b>Lambang<br>\r\n              <i>(Symbol)</i></td>\r\n\t\t\t\t\t\t\t<td nowrap><b>Skor<br>\r\n              <i>(Score)</i></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t</thead>\r\n\t\t\t\t";
    $xxx = 0;
    foreach ( $arraydatatranskrip as $k => $d2 )
    {
        $tahunlama = $d2[TAHUN];
