        ...
        else
        {
            ...
            if ( $latarfoto != "" )
            {
                ...
                if ( strtolower( $ext ) == "jpeg" || strtolower( $ext ) == "jpg" || strtolower( $ext ) == "gif" || strtolower( $ext ) == "png" || strtolower( $ext ) == "bmp" )
                {
                    ...
                    move_uploaded_file( $latarfoto, "kartu/latarfototranskrip.{$ext}" );
                }
            }
            if ( $filelogokiri != "" )
            {
                ...
                if ( strtolower( $ext ) == "jpeg" || strtolower( $ext ) == "jpg" || strtolower( $ext ) == "gif" || strtolower( $ext ) == "png" || strtolower( $ext ) == "bmp" )
                {
                    ...
                    move_uploaded_file( $filelogokiri, "kartu/logokiritranskrip.{$ext}" );
                }
            }
            if ( $filelogokanan != "" )
            {
                ...
                if ( strtolower( $ext ) == "jpeg" || strtolower( $ext ) == "jpg" || strtolower( $ext ) == "gif" || strtolower( $ext ) == "png" || strtolower( $ext ) == "bmp" )
                {
                    ...
                    move_uploaded_file( $filelogokanan, "kartu/logokanantranskrip.{$ext}" );
                }
            }
            $qdata = "";
