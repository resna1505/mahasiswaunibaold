...
//else
//{
    $href = "index.php?".$href."pilihan={$pilihan}&aksi={$aksi}&tanggalskpindahanlap[tgl]={$tanggalskpindahanlap['tgl']}&tanggalskpindahanlap[bln]={$tanggalskpindahanlap['bln']}&tanggalskpindahanlap[thn]={$tanggalskpindahanlap['thn']}&jenistampilan={$jenistampilan}&nilaidiambil={$nilaidiambil}&nilaikosong={$nilaikosong}&";
