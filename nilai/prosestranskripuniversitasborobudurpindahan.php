...
if ( $statuspindahan == "P" )
{
    ...
    do
    {
        ...
        {
            $arraydatatranskrippindahan["{$dn2['IDMAKUL']}"] = $dn2;
            ++$jmlkonversi;
        }
    } while ( 1 );
}
...
$jumlahmakuldiambilper2 = ceil( ( $jumlahmakuldiambil - $jmlkonversi ) / 2 );
if ( 0 < $jumlahmakuldiambil )
{
    $jmlkonversiper2 = ceil( $jmlkonversi / 2 );
    if ( $aksi == "cetak" )
    {
        $bodytranskrip .= "\r\n\t\t\t\t\t<br>\r\n\t\t\t\t\t<table width=900>\r\n\t\t\t\t\t <tr><td align=left>\r\n\t\t\t\t\t1. MATA KULIAH YANG DIPEROLEH DARI PERGURUAN TINGGI ASAL\r\n\t\t\t\t\t</td></tr>\r\n\t\t\t\t\t</table>\r\n\t\t\t\t\t<div class='topborder'></div>\r\n\t\t\t\t\t<table width=900 cellspacing=0 cellpadding=0>\r\n\t\t\t\t\t<tr valign=top>\r\n\t\t\t\t\t<td width=50% valign=top>";
    }
    $bodytranskrip .= "\r\n\t\t\t\t\t\r\n\t\t\t\t\t<table    border=1 width=99%  style='border-collapse:collapse;'>\r\n\t\t\t\t\t <thead style='display:table-header-group;'>\r\n\t\t\t\t\t\t<tr class=juduldata{$cetak} align=center {$borderbawah}>\r\n\t \r\n\t\t\t\t\t\t\t \r\n\t\t\t\t\t\t\t<td align=center colspan=2 {$borderkanan}  ><b>Mata Kuliah</td>\r\n\t\t\t\t\t\t\t<td align=center {$borderkanan}  ><b>Kode</td>\r\n\t\t\t\t\t\t\t<td align=center {$borderkanan}  ><b>HM</td>\r\n      \t\t\t\t\t\t\t<td align=center {$borderkanan}  ><b>AM</td>\r\n\t\t\t\t\t\t\t<td align=center {$borderkanan}  ><b>SKS</td>\r\n \r\n \t\t\t\t\t\t\t<td align=center  ><b>M</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t</thead>\r\n\t\t\t\t";
    $i = 1;
    $semlama = "";
    unset( $totals );
    if ( is_array( $arraydatatranskrippindahan ) )
    {
        foreach ( $arraydatatranskrippindahan as $k => $d2 )
        {
            if ( $aksi == "cetak" && $i == $jmlkonversiper2 + 1 )
            {
    ...
    $jumlahsksdiakui = $bobotsemuapindahan;
    $jumlahsksditempuh = $bobotsemua - $bobotsemuapindahan;
    $bodytranskrip .= "\r\n\t\t\t\t\t\t\t<tr {$kelas}{$cetak}  align=left>\r\n\t\t\t\t\t\t\t\t<td colspan=5 align=left> JUMLAH KREDIT KUMULATIF (K) DAN MUTU (M)</td>\r\n\t\t\t\t\t\t\t\t<td align=center><b>".( $bobotsemua - $bobotsemuapindahan )." </td>\r\n \r\n\t\t\r\n \t\t\t\t\t\t\t\t<td align=center><b>".number_format_sikad( $totalbm - $totalbmpindahan, 0 )."</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t</table>";
    if ( $aksi == "cetak" )
    {
        $bodytranskrip .= "\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td colspan=2>\r\n\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t";
    }
