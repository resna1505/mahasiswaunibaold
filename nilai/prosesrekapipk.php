...
$arraysort[3] = "trakm.NLIPKTRAKM DESC";
...
else
{
    ...
    if ( 0 < sqlnumrows( $h ) )
    {
        ...
        while ( $d = sqlfetcharray( $h ) )
        {
            $kelas = kelas( $i );
            $ipk = @$d[IPK];
            echo "\r\n\t\t\t\t\t<tr {$kelas}{$cetak} align=left width=40%>\r\n\t\t\t\t\t\t<td align=center width=10%>{$i}</td>\r\n\t\t\t\t\t\t<td align=center width=40%>{$d['ID']}</td>\r\n\t\t\t\t\t\t<td width=40%>{$d['NAMA']}</td>\r\n\t\t\t\t\t\t<td align=center width=40%> ".number_format_sikad( $d[SKS], 2, ".", "," )."</td>\r\n\t\t\t\t\t\t<td align=center width=40%>".number_format_sikad( $ipk, 2, ".", "," )."</td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t";
            $ipks += $ipk;
            $totalssemua += $d[BOBOT];
            $bobotssemua += $d[SKS];
            $bobotsemua = 0;
        ...
        echo "\r\n\t\t\t\t\t<tr width=20%>\r\n\t\t\t\t\t\t<td align=right colspan=3 width=40%>Total</td>\r\n\t \t\t\t\t\t<td align=center width=40%> ".number_format_sikad( $bobotssemua, 2, ".", "," )."</td>\r\n\t\t\t\t\t\t<td align=center width=40%>".number_format_sikad( $ipks, 2, ".", "," )."</td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t\t<tr >\r\n\t\t\t\t\t\t<td align=right colspan=3>Rata-rata</td>\r\n \t\t\t\t\t\t<td align=center> ".number_format_sikad( $bobotssemua / ( $i - 1 ), 2, ".", "," )."</td>\r\n\t\t\t\t\t\t<td align=center>".number_format_sikad( $ipks / ( $i - 1 ), 2, ".", "," )."</td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t\t<tr {$kelas}{$cetak}>\r\n\t\t\t\t\t\t<td align=right colspan=3>IPK Tertinggi</td>\r\n \t\t\t\t\t\t<td align=center>&nbsp;</td>\r\n\t\t\t\t\t\t<td align=center> \r\n            ".number_format_sikad( $ipkmax, 2, ".", "," )."\r\n             </td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t\t<tr {$kelas}{$cetak}>\r\n\t\t\t\t\t\t<td align=right colspan=3>NIM IPK Tertinggi</td>\r\n \t\t\t\t\t\t\r\n\t\t\t\t\t\t<td colspan=2 align=left> \r\n            ";
        foreach ( $nimipkmax as $k => $v )
        {
            echo "<b>{$k} / ".$namaipkmax[$k]."<br>";
        }
        echo "\r\n             </td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t\t<tr {$kelas}{$cetak}>\r\n\t\t\t\t\t\t<td align=right colspan=3>IPK Terendah</td>\r\n \t\t\t\t\t\t<td align=center>&nbsp;</td>\r\n\t\t\t\t\t\t<td align=center>".number_format_sikad( $ipkmin, 2, ".", "," )."</td>\r\n\t\t\t\t\t</tr>\r\n\t\t\t\t\t<tr {$kelas}{$cetak}>\r\n\t\t\t\t\t\t<td align=right colspan=3>NIM IPK Terendah</td>\r\n \t\t\t\t\t\t\r\n\t\t\t\t\t\t<td colspan=2 align=left> \r\n            ";
