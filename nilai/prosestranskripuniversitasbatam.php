...
if ( 0 < $jumlahmakuldiambil )
{
    ...
    if ( is_array( $arraydatatranskrip ) )
    {
        foreach ( $arraydatatranskrip as $k => $d2 )
        {
            ...
            {
                $bodytranskrip .= "\r\n\t\t\t\t\t\t\t\t</table><div style='border-top:1px solid black;margin-top:-2px;'></div>\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t<td valign=top>\r\n\t\t\t\t\t\t\t\t<table class=borderline {$borderx}  border=0  >\r\n      \t\t\t\t\t <thead style='display:table-header-group;'>\r\n\t\t\t\t\t\t\t\t\t<tr class=juduldata{$cetak} align=center>\r\n\t\t\t\t \r\n\t\t\t\t\t\t\t\t\t\t<td align=center><b>No</td>\r\n\t\t\t\t\t\t\t\t\t\t<td align=center><b>Kode</td>\r\n\t\t\t\t\t\t\t\t\t\t<td align=center><b>Mata Kuliah</td>\r\n      \t\t\t\t\t\t\t<td align=center><b>K</td>\r\n       \r\n      \t\t\t\t\t\t\t<td align=center><b>N</td>\r\n       \t\t\t\t\t\t\t<td align=center><b>K.N</td>\r\n\t\t\t\t\t\t\t\t\t</tr>\t\t\t\t\t\t\t\t\t\r\n\t\t\t            </thead>\t\t\t\t\t\r\n\t\t\t\t\t\t\t";
            }
            unset( $kp );
            if ( $konversisemua == 0 )
            {
    ...
    if ( $d[JENIS] == 0 )
    {
        ...
        $bodytranskrip .= "\r\n\t\t\t\t\t\t\t\t\t<tr><td width=25%>\r\n\t\t\t\t\t\t\t\t\t\t<b>Indeks Prestasi Kumulatif (IPK)</td><td><b>:  {$ipkkuteks} ({$tmp1} koma {$tmp2})<br>\r\n\t\t\t\t\t\t\t\t\t\t</td></tr>";
    }
    else
    {
        /*if ( 0 )
        ...
        #$bodytranskrip .= "\r\n\t\t\t\t\t\t\t\t\t<tr><td>\r\n\t\t\t\t\t\t\t\t\t\t<b>Indeks Prestasi Kumulatif (IPK)</td><td><b>:  ".number_format_sikad(@($totalsemua/$bobotsemua),2,'.',',')." <br>\r\n\t\t\t\t\t\t\t\t\t\t</td></tr>\r\n\t\t\t\t\t\t\t\t\t<tr>\r\n                    <td>\r\n  \t\t\t\t\t\t\t\t\t\t<b>Ujian AKhir Program (UAP)</td><td><b>:  ".number_format_sikad(@($d[IPKUAP]),2,'.',',')." <br>\r\n\t\t\t\t\t\t\t\t\t\t</td>\r\n                  </tr>\r\n\t\t\t\t\t\t\t\t\t\t <!--\r\n\t\t\t\t\t\t\t\t\t<tr><td>\r\n\t\t\t\t\t\t\t\t\t\t<b>Indeks Prestasi Kumulatif (IPK)</td><td><b>: {$ipkkuteks}  ({$tmp1} koma {$tmp2}) <br>\r\n\t\t\t\t\t\t\t\t\t\t</td></tr>\r\n\t\t\t\t\t\t\t\t\t\t-->\r\n\t\t\t\t\t\t\t\t\t \r\n\t\t\t\t\t\t\t\t\t\t";
    ...
    $bodytranskrip .= "\r\n\t\t\t\t\t\t\t\t\t<tr><td>\r\n\t\t\t\t\t\t\t\t<b>Tanggal Yudisium </td><td>:  <b>{$tglyudisium2} <br>\r\n\t\t\t\t\t\t\t\t\t</td></tr>\r\n\t\t\t\t\t\t\t\t\t<tr><td>\r\n\t\t\t\t\t\t\t\t<b>Predikat </td><td>:  <b>{$predikat} <br>\r\n\t\t\t\t\t\t\t\t\t</td></tr>\r\n\t\t\t\t\t\t\t\t\t<tr valign=top align=left>\r\n\t\t\t\t\t\t\t\t\t\t<td   ><b>Judul Skripsi  </td> \r\n\t\t\t\t\t\t\t\t\t\t\t<td><b>: \r\n\t\t\t\t\t\t\t\t\t\t".str_replace( "\n", "<br>", $d[TA] )." </td>\r\n\t\t\t\t\t\t\t\t\t\t \r\n\t\t\t\t\t\t\t\t\t\t</tr> \r\n\r\n\t\t\t\t\t\t\t\t</table>\r\n\t\t\t\t\t\t\t\t</p>\r\n \r\n ";
    @include( "footertranskripuniversitasbatam.php" );
    $bodytranskrip .= "\r\n\t\t\t\t\t\t";
