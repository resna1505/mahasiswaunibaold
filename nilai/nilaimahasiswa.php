...
printmesg( $errmesg );
$q = "SELECT pengambilanmk.BOBOT,pengambilanmk.SIMBOL,pengambilanmk.IDMAKUL,pengambilanmk.TAHUN,tbkmk.NAKMKTBKMK AS NAMAMAKUL,pengambilanmk.NAMA,".
"pengambilanmk.SKSMAKUL AS SKS,pengambilanmk.SEMESTER AS SEMESTERS,pengambilanmk.SEMESTERMAKUL AS SEMESTER ".
"FROM pengambilanmk,tbkmk,msmhs WHERE pengambilanmk.IDMAHASISWA='{$idmahasiswa}' AND pengambilanmk.IDMAKUL=tbkmk.KDKMKTBKMK ".
								...
								<table class=\"table table-bordered table-hover\">
									<thead>
										<tr class=juduldata{$cetak} align=center>
											<td  colspan=5><b>Semester ".( $semesterhitungx + $plus1 )."</b>,  {$tahunupdate}/".( $tahunupdate + 1 )." ".$arraysemester[$semesterupdate]."</td><td>";
			if ( $tingkataksesusers[$kodemenu] == "T" )
            {
                echo "<input type=submit name=aksi2 class=\"btn btn-brand\" value='Simpan'>";
            }
            echo "						</td></tr><tr class=juduldata{$cetak} align=center><td>No</td><td >Kode</td><td width=300>Nama Mata Kuliah</td><td >SKS</td><td>Lambang</td><td>Mutu</td></tr>";
