    ...
    if ( 0 < sqlnumrows( $h ) )
    {
        ...
        while ( $d = sqlfetcharray( $h ) )
        {
            ...
            else
            {
                ...
                $NO_SERIIJAZAH = "";
                $q = "SELECT NOIJATRLSM,TGLRETRLSM,NOTRANSKRIP,NOBLANKO,NILAIUAPTULIS,NILAIUAPPRAKTEK,SIMBOLUAPTULIS,SIMBOLUAPPRAKTEK,PEMINATAN FROM trlsm WHERE NIMHSTRLSM='{$d['ID']}' AND STMHSTRLSM ='L'";
