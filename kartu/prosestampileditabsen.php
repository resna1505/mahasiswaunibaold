...
set_time_limit(0);
periksaroot();
$pakaiborder = "style='border-collapse:collapse; border:1px solid black;'";
$stylecetak = "<style type=\"text/css\">.form td{border:none;padding:2px 5px;}@media print {thead {display: table-header-group;}}</style>";
    ...
    */
	...
	$bodycetak .= "					<div class=\"form-group m-form__group row\" style=\"background-color:#f7f8fa;\">
									...
									<div class=\"form-group m-form__group row\">
										...
										<label class=\"col-form-label\" style=\"padding-left:0;width:auto;\">: <!-- {$iddosenupdate}, --> ".getnamafromtabel( $iddosenupdate, "dosen" )." / ".$dosenlain."</label>
									</div>
									<!--\r\n    <tr class=judulform>\r\n\t\t\t<td>Pengawas</td>\r\n\t\t\t<td>: \t\t\t\r\n\t\t\t</td>\r\n\t\t</tr>\r\n\t\t-->
								</div>
							</form>
...
if ( 0 < sqlnumrows( $h ) )
{
    ...
    while ( $d = sqlfetcharray( $h ) )
    {
        ...
        else if ( $jenis == "UAS" )
        {
			...
			$bodycetak .= "\r\n              <td> </td>\r\n              <td width=40> </td>\r\n              <td width=40> </td>\r\n              <td width=40> </td>\r\n              <td width=40> </td>\r\n              <td width=40> </td>\r\n              <td nowrap align=center>A  A- B+ B  C+ C D E</td>\r\n              ";
