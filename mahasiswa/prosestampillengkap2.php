    ...
    if ( 0 < sqlnumrows( $h2 ) )
    {
        echo "\r\n        <br><br>\r\n   \t\t\t<div class=\"portlet-body\">
						<div class=\"table-scrollable\">
                            <table class=\"table table-striped table-bordered table-hover {$border} class=form{$aksi}>\r\n  \t\t\t<tr class=juduldata{$aksi} align=center {$height}'>\r\n  \t\t\t   <td>NIM</td>\r\n  \t\t\t   <td>Nama</td>";
        ...
        {
            $kelas = kelas( $i );
            echo "\r\n  \t\t\t\t<tr align=center {$kelas}{$aksi} {$height}>\r\n  \t\t\t\t<td>{$d2['ID']}&nbsp;</td>\r\n  \t\t\t\t<td align=left nowrap>{$d2['NAMA']}&nbsp;</td>";
