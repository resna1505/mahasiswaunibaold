...
$href = "index.php?pilihan={$pilihan}&aksi=tampilkan& <div style='overflow-x:auto;'>";
if ( $idprodi != "" )
{
...
if ( 0 < sqlnumrows( $h ) )
{
    ...
    do
    {
        ...
        else
        {
            ...
            echo "\t\t<table class=\"reset card\" cellspacing=0 cellpadding=0\r\n\t\tstyle='border:none;border-width:1;border-collapse:collapse;margin-bottom: 20px;'\r\n    style='";
            echo $bgkartu;
            echo "    width:";
            echo $konfigkartu[PANJANG];
            echo "mm;height:";
            echo $konfigkartu[LEBAR];
            echo "mm;'>\r\n\t\t<tr valign=top><td class=loseborder>\r\n\t\t<table  class=\"reset\" border=0 cellspacing=4 cellpadding=0 \r\n\t\t \r\n\t\t style='";
            echo $bgkartu;
            echo "; border:none;border-width:1;border-collapse:collapse;width:";
            echo $konfigkartu[PANJANG];
            echo "mm;height:";
            echo $konfigkartu[LEBAR];
            echo "mm;'>\r\n\t\t<tr valign=top class=loseborder>\r\n\t\t<td colspan=3  align=center valign=top  class=loseborder \r\n    >\r\n\t \r\n\t\t\r\n\t\t";
            echo "\r\n\t\t<table class='reset' width=100% cellpadding=1 cellspacing=1 >\r\n\t\t  <tr>";
        }
        ...
        echo "\r\n        <td align=center width=*  valign=top class=loseborder>\r\n        <b>";
        ...
        {
            echo "\r\n      \t\t<table   class='reset' border=0 cellpadding=0 cellspacing=0>";
            foreach ( $arraydatakartupilih as $v )
            {
                if ( $v != "" )
                {
                    echo "\r\n      \t\t  <tr  valign=top>\r\n      \t\t   <td nowrap {$stylecetaktmp} valign=top  > ".$arraydatakartu[$v][J]." </td>\r\n      \t\t   <td    {$stylecetaktmp}>:</td>\r\n      \t\t   <td {$stylecetaktmp}>".$d[$arraydatakartu[$v][F]]."</td>\r\n      \t\t  </tr>\r\n            ";
                }
            }
            echo "\r\n      \t\t</table>\r\n        ";
        }
