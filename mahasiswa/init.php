...
$FOLDERFILE = "foto";
$NAMATABEL = "mahasiswa";
$NAMATABELBEBAS = "mahasiswa2";
if ( $UNIVERSITAS == "UNM" )
{
    $arraydefaultmhs[kota] = "Makassar";
    $arraydefaultmhs[tahun] = 1988;
    $arraydefaultmhs[kelas] = "01";
    $arraydefaultmhs[tahunsemesterawal] = 20071;
    $arraydefaultmhs[tahunsemesterbatas] = 20141;
    $arraydefaultmhs[propinsi] = 19;
}
else
{
    $arraydefaultmhs[kota] = "";
    $arraydefaultmhs[tahun] = 1988;
    $arraydefaultmhs[kelas] = "01";
    $arraydefaultmhs[tahunsemesterawal] = $waktu[year]."1";
    $arraydefaultmhs[tahunsemesterbatas] = ( $waktu[year] + 7 )."1";
    $arraydefaultmhs[propinsi] = "";
}
...
$arraynamagrup[6] = "Tahun Akademik";
