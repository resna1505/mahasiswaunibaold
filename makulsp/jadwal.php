...
if ( $aksi3 == "hapus" )
{
    $q = "DELETE FROM  jadwalkuliahkurikulumsp\r\n      WHERE\r\n      IDMAKUL='{$idupdate}' AND\r\n      IDPRODI='{$idprodimakul}' AND\r\n      JAM='{$jammulai}' AND\r\n      KELAS='{$kelas}' AND\r\n      TAHUN='".( $thnsyarat + 1 )."' AND\r\n      SEMESTER='{$semsyarat}'\r\n      ";
    mysqli_query($koneksi,$q);
}
...
$q = "SELECT jadwalkuliahkurikulumsp.* ,makul.NAMA\r\nFROM jadwalkuliahkurikulumsp , makul\r\nWHERE\r\nmakul.ID=jadwalkuliahkurikulumsp.IDMAKUL \r\nAND\r\nIDMAKUL='{$idupdate}'\r\nAND jadwalkuliahkurikulumsp.TAHUN='".( $thnsyarat + 1 )."'\r\nAND jadwalkuliahkurikulumsp.SEMESTER='{$semsyarat}'\r\nAND jadwalkuliahkurikulumsp.IDPRODI='{$idprodimakul}'\r\nORDER BY KELAS,JAM\r\n\r\n";
