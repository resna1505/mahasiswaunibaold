    ...
    else
    {
        ...
        else
        {
                ...
                if ( $aksi4 == "Ambil" )
                {
                    if ( $pilihkelas != "" )
                    {
                        ...
                        else if ( $syaratok == 1 )
                        {
                            ...
                            else if ( $sksmaksimum < $sksmakul + $sksdiambil && $syaratkrs == 1 && 0 <= $sksmaksimum )
                            {
            ...
            if ( $aksi == "" )
            {
                ...
                echo "\r\n  <table>\r\n    <tr>\r\n      <td> \r\n    Anda dapat mengedit <b>{$strpkrs} Kartu Rencana Studi</b> untuk Semester ".$arraysemester[$semesterupdate]." ".( $tahunupdate - 1 )."/{$tahunupdate} dari tanggal <b>{$tanggalmulai}</b> s.d <b>{$tanggalselesai}</b>. Untuk mengedit KRS, silakan klik link di bawah ini\r\n    <br><br>\r\n    <a href='index.php?pilihan={$pilihan}&aksi=tampiledit&pilihtampil2=1'>Edit KRS</a>\r\n    </td>\r\n    </tr>\r\n    </table>\r\n    \r\n  ";
            }
        }
    }
}
