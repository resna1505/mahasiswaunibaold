...
if ( $aksi == "" )
{
                ...
                <div class=\"col-md-12\">
                    ...
                    ";
                        ...
                        echo "			<div class='portlet-title'>";
												printmesg("Hasil Tugas Kuliah Semester Pendek");
								echo "	</div>";
    ...
    echo "			<div class='portlet-title'>";
						printmesg("Daftar Pengumpul Tugas Kuliah Semester Pendek");
	echo "			</div>";
    $q = "\r\n\t\t\tSELECT hasiltugaskuliahsp.*,mahasiswa.NAMA \r\n      FROM hasiltugaskuliahsp,mahasiswa\r\n\t\t\tWHERE IDMAKUL='{$idmakulupdate}'\r\n\t\t\tAND TAHUN='{$tahunupdate}'\r\n\t\t\tAND SEMESTER='{$semesterupdate}'\r\n\t\t\tAND hasiltugaskuliahsp.KELAS='{$kelasupdate}'\r\n\t\t\tAND IDBAHAN='{$idupdate}'\r\n\t\t\tAND mahasiswa.ID=hasiltugaskuliahsp.IDMAHASISWA\r\n\t\t\tORDER BY IDMAHASISWA\r\n\t\t";
    $h = mysqli_query($koneksi,$q);
    if ( 0 < sqlnumrows( $h ) )
    {
    ...
    {
        $errmesg = "Data Hasil Tugas Kuliah Semester Pendek belum ada";
        printmesg( $errmesg );
    }
}
?>
