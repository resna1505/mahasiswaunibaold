...
$q = "SELECT COUNT(*) AS JML FROM dosenpengajarsp, dosen \r\n\tWHERE 1=1\r\n\tAND dosen.ID=dosenpengajarsp.IDDOSEN  \r\n\t{$qfield}\r\n\t";
$h = mysqli_query($koneksi,$q);
$d = sqlfetcharray( $h );
$total = $d[JML];
include( "../paginating.php" );
$q = "SELECT  \r\n\t dosenpengajarsp.*, dosen.NAMA AS NAMADOSEN \r\n\tFROM dosenpengajarsp, dosen \r\n\tWHERE 1=1\r\n\tAND dosen.ID=dosenpengajarsp.IDDOSEN  \r\n\t{$qfield}\r\n\tORDER BY ".$arraysort[$sort]." {$qlimit}";
$h = mysqli_query($koneksi,$q);
if ( 0 < sqlnumrows( $h ) )
{
    ...
    echo "						<div class=\"caption\">";
												printmesg("Data Mata Kuliah Semester Pendek");
