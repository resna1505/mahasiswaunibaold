...
if ( $prodis == "" && $jenisusers == 0 )
{
    ...
    if ( $aksi == "hapus" )
    {
        ...
        else
        {
            ...
            $q = "DELETE FROm waktunilaisp WHERE TAHUN='{$tahunhapus}' AND SEMESTER='{$semesterhapus}'";
    ...
    if ( $aksi == "" )
    {
		...
		echo "					<form action='index.php' method=post class=\"m-form m-form--fit m-form--label-align-right m-form--group-seperator\">
									...
									<input type=hidden name=sessid value='{$token}'><div class=\"m-portlet__body\">		
        ...
        $q = "SELECT * FROM waktunilaisp ORDER BY TAHUN,SEMESTER";
