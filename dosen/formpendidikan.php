...
echo "	<div class=\"form-group m-form__group row\">
		...
		<div class=\"form-group m-form__group row\"  style=\"background-color:#f7f8fa;\">
			...
			<div class=\"col-lg-6\">".createinputtext( "gelar", $d2[GELARMSPDS], " class=masukan  size=10" )."</div>
		</div>
		...
		<div class=\"form-group m-form__group row\"  style=\"background-color:#f7f8fa;\">
			...
			<div class=\"col-lg-6\">".createinputtext( "namapt", $d2[NMPTIMSPDS], " class=masukan  size=50" )."Hanya diisi jika Kode PT tidak ada di daftar PT</div>
		</div>
		<div class=\"form-group m-form__group row\">
			<label class=\"col-lg-2 col-form-label\">Bidang Ilmu</label>\r\n    
			<div class=\"col-lg-6\">".createinputtext( "bidangilmu", $d2[BIDILMSPDS], " class=masukan  size=40" )."</div>
		</div>
		<div class=\"form-group m-form__group row\"  style=\"background-color:#f7f8fa;\">
			<label class=\"col-lg-2 col-form-label\">Kota Asal</label>\r\n    
			<div class=\"col-lg-6\">".createinputtext( "kotaasal", $d2[KOTAAMSPDS], " class=masukan  size=20" )."</div>
		</div>
		<div class=\"form-group m-form__group row\">
		...
		<div class=\"form-group m-form__group row\"  style=\"background-color:#f7f8fa;\">
			...
			<div class=\"col-lg-6\">".createinputtanggal( "data", $dtk, " class=masukan" )."</div>
		</div>
		";
