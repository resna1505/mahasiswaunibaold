...
if ( $aksi == "" )
{
    printjudulmenu( "Cari Data Pembayaran Keuangan Rekening Koran Mahasiswa" );
    printmesg( $errmesg );
    ...
    echo "\r\n  \t\t<tr >\r\n\t\t\t<td class=judulform>No. Jurnal</td>\r\n\t\t\t<td>".createinputtext( "no_jurnal", "", " class=masukan  size=20 id='inputString' " )."\r\n\t\t\t</td>\r\n\t\t</tr>";
    echo "\r\n  \t\t<tr >\r\n\t\t\t<td class=judulform>Amount</td>\r\n\t\t\t<td>".createinputtext( "amount", "", " class=masukan  size=20 id='inputString' " )."\r\n\t\t\t</td>\r\n\t\t</tr>";
    echo "\r\n  \t\t<tr >\r\n\t\t\t<td class=judulform>Keterangan</td>\r\n\t\t\t<td>".createinputtext( "keterangan", "", " class=masukan  size=20 id='inputString' " )."\r\n\t\t\t</td>\r\n\t\t</tr>";
