...
if ( $aksi == "Lanjut" )
{
    ...
    #if ( $tanggal != "" &&)
	{
		...
		{$qfield} 
		UNION ALL
		SELECT   komponenpembayaran.JENIS,c.TINGKAT,komponenpembayaran.LABELSPC,a.IDKOMPONEN,d.IDPRODI,a.ANGKATAN,a.BIAYA,a.TANGGAL,a.GELOMBANG,
		...
		echo "			<div class=\"m-portlet\">
         ...
         echo "					
									<!--<div align=center id='linkdownload' >
										...
										<div align='center' class=\"form-group m-form__group row\" style=\"background-color:#d8e2f7;\" id='linkdownload'>
											<div class=\"col-lg-6\">
            ...
            while ( $d = sqlfetcharray( $h ) )
            {
                ...
                $url = "idprodi=".$d[IDPRODI]."&angkatan=".$d[ANGKATAN]."&gelombang=".$d[GELOMBANG]."&jeniskelas=".$d[JENISKELAS]."&idkomponen=".$d[IDKOMPONEN]."&tgl={$d['TANGGALTAGIH']}&tanggal={$tanggal}&jeniskolom={$jeniskolom}&tingkat={$d['TINGKAT']}&totalkomponenakhir={$totalkomponen}";
...
<div class=\"row\">
    ...
    if ( 0 < $jml )
    {
		...
		echo "			<div class='portlet-title'>";
								printtitle("Unduh Hasil Pembuatan Tagihan Sebelumnya");
		echo "			</div>";
        echo "			<form method=post action=downloadtagihan.php target=_blank class=\"m-form m-form--fit m-form--label-align-right m-form--group-seperator\">
							<div class=\"m-portlet__body\">
								<div class=\"form-group m-form__group row\" style=\"background-color:#d8e2f7;\">
									<label class=\"col-lg-2 col-form-label\">Tanggal Tagihan</label>\r\n    
									<label class=\"col-form-label\">
    ...
    echo "						<div class=\"form-group m-form__group row\" style=\"background-color:#d8e2f7;\">
		...
		echo "			<div class='portlet-title'>";
								printtitle("Hapus Hasil Pembuatan Tagihan Sebelumnya");
		echo "			</div>";
