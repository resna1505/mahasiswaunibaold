...
else
{
    ...
    $q = "SELECT komponenpembayaran.LABELSPC,komponenpembayaran.JENIS,buattagihanvamandiri.*,buattagihanvamandiri.JUMLAH AS JUMLAH,buattagihanvamandiri.STATUS AS SUDAHDIPROSES,
	buattagihanvamandiri.STATUS AS TOTALDATA,a.NAMA,a.IDPRODI,a.ANGKATAN ,a.ALAMAT,prodi.NAMA AS NAMAPRODI, prodi.TINGKAT,
	departemen.NAMA AS NAMAJURUSAN,fakultas.NAMA AS NAMAFAKULTAS FROM mahasiswa a, prodi, departemen LEFT JOIN fakultas 
	ON fakultas.ID=departemen.IDFAKULTAS,buattagihanvamandiri,komponenpembayaran WHERE departemen.ID=prodi.IDDEPARTEMEN AND 
	a.IDPRODI=prodi.ID AND buattagihanvamandiri.IDKOMPONEN=komponenpembayaran.ID AND 
	a.ID=buattagihanvamandiri.IDMAHASISWA AND buattagihanvamandiri.TANGGALTAGIHAN='{$tanggal}' AND komponenpembayaran.KODEBANK='88180' {$qfield} 
                        ...
                        <div class=\"portlet light\">
							<div class='portlet box blue'>
								<div class=\"portlet-title\">";
									printmesg( $errmesg );
									printtitle("Koreksi Tagihan VA Mandiri");
									printmesg( $qjudul );
