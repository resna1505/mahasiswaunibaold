...
if ( 0 < sqlnumrows( $h ) )
{
    ...
    if ( $aksi != "cetak" )
    {
		...
		echo "					<div class=\"tools\">
										<form target=_blank action='cetaklaporan1.php' method=post>
...
<div class=\"row\">
                    ...
                    <div class=\"portlet light\">
                        <div class=\"portlet-title\">
                            <div class=\"caption font-green-haze\">
                                ...
                                <span class=\"caption-subject bold uppercase\"> Laporan Keuangan : Mahasiswa yg Sudah Membayar </span>
                            </div>
                            <div class=\"actions\">
    ...
    echo "\r\n \t\t\t\t<td><a class='{$cetak}' href='{$href}"."sort=3'>Biaya<br>Rp.</td>\r\n \t\t\t\t<td><a class='{$cetak}' href='{$href}"."sort=4'>Jumlah<br>Bayar Rp.</td>";
    if ( $jenisbayar != 1 )
    {
        echo "\r\n \t\t\t\t\t\t<td>Sisa<br>Rp.</td>\r\n \t\t\t\t\t";
    }
    echo "\r\n\t\t\t\t<td><a class='{$cetak}' href='{$href}"."sort=5'>Bulan/Sem/<br>Tahun<br>Ajaran</td>\r\n  \t\t\t</tr>\r\n\t\t";
	echo "			</thead>
					<tbody>";
    $i = 1;
