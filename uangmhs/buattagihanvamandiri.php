			...
			<div class=\"row\">
                <div class=\"col-md-12\">
                    ...
                    ";
						printmesg( $errmesg );
		echo "			<div class='portlet-title'>";
								printtitle("Buat Tagihan VA Mandiri");
		echo "			</div>";
...
$h = mysqli_query($koneksi,$q);
    ...
    if ( 0 < $jml )
    {
		...
		echo "			</div>";
        echo "			<form method=post action=downloadtagihanvamandiri.php target=_blank class=\"m-form m-form--fit m-form--label-align-right m-form--group-seperator\">
							<div class=\"m-portlet__body\">
								<div class=\"form-group m-form__group row\" style=\"background-color:#b0c6f1;\">
									<label class=\"col-lg-2 col-form-label\">Tanggal Tagihan</label>\r\n    
									<label class=\"col-form-label\">
