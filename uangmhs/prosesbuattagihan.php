				...
				foreach ( $arraysettingcicilan as $tanggalsetting => $datasetting )
				{
					...
					if(($d2['TOTAL']==NULL || $d2['TOTAL']==0) && ($idkomponen=='032' || $idkomponen=='268' || $idkomponen=='269'))
					{
						...
						if($tahunawaluntukselisih.$bulanawaluntukselisih<202001){
							#$totalbayardendabefore["".$datasetting[TAHUN]]["".$datasetting[SEMESTER]]+= 100000;
							#$qharidenda = "SELECT TO_DAYS(LAST_DAY('{$tahunawaluntukselisih}-{$bulanawaluntukselisih}-{$tglawaluntukselisih}'))-TO_DAYS('{$tahunawaluntukselisih}-{$bulanawaluntukselisih}-{$TANGGALMULAIDENDA}') AS HARIDENDA ";
