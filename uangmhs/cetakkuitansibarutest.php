...
else
{
    ...
    echo "TANGGAL".$datatgl;
    echo "WAKTU".$datajam;		
    list($tahunkwitansi,$bulankwitansi,$tglkwitansi)=explode("-",$datatgl);
    list($jamkwitansi,$menitkwitansi,$detikkwitansi)=explode(":",$datajam);
			
	#echo "masuk";
		$format_kwitansi="INV/".$arrayromawi[$bulankwitansi]."/".$tahunkwitansi."/".$jamkwitansi.$menitkwitansi.$detikkwitansi;		
		#echo "FROMAT=".$format_kwitansi;exit();
		echo "<center>
					<table width=96%>
						<tr>
								...
								<table width=100% class=form>
									<tr class=judulform>
										<td width=15% class=loseborder rowspan='2'>
											<img src=\"../gambar/kwitansi_uniba_logo.png\" width=\"120\" height=\"109\">
										</td>
							...
							<td width=40% class=loseborder>
								<table width=100% class=form>
									<tr class=judulform>
										...
										<td  class=loseborder>: {$format_kwitansi}</td>
									</tr>
									<tr>
