									...
									<div class=\"m-section__content\">
										<div class=\"table-responsive\">
											<table class=\"table table-bordered table-hover\">
												<thead>
													<tr class=juduldata{$aksi} align=center>\r\n\t\t\t\t<td>No</td>\r\n \t\t\t\t<td><a class='{$cetak}' href='{$href}"."sort=0'>Kode</td>\r\n\t\t\t\t<td><a class='{$cetak}' href='{$href}"."sort=1'>Nama</td>\r\n\t\t\t\t<td><a class='{$cetak}' href='{$href}"."sort=2'>Jenis</td>\r\n\t\t\t\t<td><a class='{$cetak}' href='{$href}"."sort=3'>Label SPC</td><td><a class='{$cetak}' href='{$href}"."sort=4'>Kode Bank Mandiri</td><td><a class='{$cetak}' href='{$href}"."sort=5'>Kode Rekening Mandiri</td><td><a class='{$cetak}' href='{$href}"."sort=6'>Kode BNI</td><td><a class='{$cetak}' href='{$href}"."sort=7'>Kode Rekening BNI</td>";
