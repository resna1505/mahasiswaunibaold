...
<div class=\"row\">
    ...
    echo "													<input type=text size=8 name=jamawal class=form-control m-input style=\"width:auto;display:inline-block;\" value='{$jamawal}'>s.d
															<input type=text size=8 name=jamakhir class=form-control m-input style=\"width:auto;display:inline-block;\" value='{$jamakhir}'> (jj:mm:dd)
														</label>
													</div>
													<div class=\"form-group m-form__group row\">
