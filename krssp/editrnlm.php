...
if ( $sem == 1 || $sem == 2 )
{
    $q = "SELECT IDPRODI FROM makul WHERE ID='{$idmakul}'";
    ...
    $q = "INSERT INTO trnlmsp \r\n          (THSMSTRNLM ,KDPTITRNLM ,KDPSTTRNLM ,KDJENTRNLM ,NIMHSTRNLM ,KDKMKTRNLM,KELASTRNLM  )\r\n          VALUES\r\n          ('".( $tahunlama - 1 )."{$sem}','{$kodept}','{$kodeps}','{$kodejenjang}','{$idmahasiswa}','{$idmakul}','{$kelasmk}')";
