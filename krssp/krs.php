...
#printjudulmenu( "Data KRS Semester Pendek Mahasiswa Perwalian" );
                ...
                <div class=\"col-md-12\">
                    ...
                    ";
                        ...
                        echo "			<div class='portlet-title'>";
												printmesg("Data KRS Semester Pendek Mahasiswa Perwalian");
								echo "	</div>";
$tmpcetak = "";
    ...
    else
    {
        ...
        else
        {
			...
			$tmpcetak .= "		<div class='portlet-title'>";
								printmesg("Data Mata Kuliah Semester Pendek Yang Telah Diambil");
			$tmpcetak .= "	</div>";
