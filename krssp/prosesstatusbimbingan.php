...
$q = "SELECT   ID,mahasiswa.NAMA  ,\r\n\tmahasiswa.ANGKATAN,statusbimbingansp.STATUS ,LASTUPDATE,UPDATER\r\n\t \r\n\tFROM  mahasiswa LEFT JOIN statusbimbingansp ON statusbimbingansp.IDMAHASISWA=mahasiswa.ID\r\n\tAND statusbimbingansp.TAHUN='{$tahun}'\r\n\tAND statusbimbingansp.SEMESTER='{$semester}'\r\n\tWHERE  IDDOSEN='{$users}'\r\n\t \r\n\t{$qfield}\r\n\tORDER BY {$sort}  ";
